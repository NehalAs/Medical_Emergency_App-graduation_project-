...
class Burn_Image extends StatefulWidget {
  const Burn_Image({Key? key}) : super(key: key);

  @override
  State<Burn_Image> createState() => _HomeState();
}

class _HomeState extends State<Burn_Image> {
  File? image;
